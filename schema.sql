...
CREATE TABLE IF NOT EXISTS Weeks (weekId TEXT PRIMARY KEY, startDate TEXT, endDate TEXT, active BOOLEAN);
CREATE TABLE IF NOT EXISTS Seasons (seasonId TEXT PRIMARY KEY, startDate TEXT, endDate TEXT, active BOOLEAN);
